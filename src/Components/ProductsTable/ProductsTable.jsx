...
function ProductsTable() {
  ...
  const columns = [
    ...
    { field: 'img', headerName: ' عکس', width: 80 ,
        renderCell: (product) => {
      return (
        <img src={`src/assets/Images/Products/${product.row.productImg}`} className='object-fill h-16' alt='ghorbani-dev.ir' />
      );
    }},
    ...
    { field: 'showDetails', headerName: '  جزییات', width: 80 , 
    renderCell: (product) => {
      return (
